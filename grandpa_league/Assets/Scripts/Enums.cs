static class Enums
{
    ...
    public enum EventOutcome { SUCCESS = 0, FAILURE = 1, PASS = 2, SUCCESS_BLACKLIST_YEAR = 3, FAILURE_BLACKLIST_YEAR = 4, SUCCESS_BLACKLIST_FOREVER = 5, FAILURE_BLACKLIST_FOREVER = 6 }
